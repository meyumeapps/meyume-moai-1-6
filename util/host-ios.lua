...
copyhostfiles = function() 
  ...
  MOAIFileSystem.deleteDirectory(output..'MOAI Template/Classes')
	MOAIFileSystem.deleteDirectory(output..'host-modules',true)

    local classes = MOAI_SDK_HOME..'xcode/ios/Classes'
    local hostmodules = MOAI_SDK_HOME..'src/host-modules'
    
    MOAIFileSystem.copy(classes, output..'app/Classes')
    MOAIFileSystem.copy(hostmodules, output..'host-modules')
    MOAIFileSystem.copy(MOAI_SDK_HOME..'xcode/ios/main.mm', output..'app/main.mm')
end
